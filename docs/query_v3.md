...
Once the BitDB [crawler](https://docs.fountainhead.cash/docs/crawler) and [indexer](https://docs.fountainhead.cash/docs/indexer) are up and running, you can query your BitDB node any way you want. It's just a MongoDB instance after all.
